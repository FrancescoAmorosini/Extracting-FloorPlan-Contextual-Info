...
def __main__():
    ...
    wallimg, bitimg = detect_walls(path, draw_histogram= True)
    visualize_graph(wallimg, anns, colors, showImg=True, showGraph=True)
...
big = 'G0316 G0478 032 001 G0065 G0004> 15  G1006'
